  ...
  return (
    <div className={clsx(styles.card, cardHeight, className)}>
      <div className={styles.titleContainer}>
        ...
        <div>
          {download && (<Button variant="primary" onClick={download} icon={<FaFileDownload size={18} />} >Exportar</Button>)}
          {create && (<Button variant="primary" onClick={create} icon={<FaFileDownload size={18} />} >Novo</Button>)}
        </div>
      </div>
